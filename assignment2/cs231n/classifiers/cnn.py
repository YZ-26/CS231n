...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        loss+=0.5*self.reg*(np.sum(self.params['W2']*self.params['W2'])+np.sum(self.params['W1'] * self.params['W1'])+np.sum(self.params['W3'] * self.params['W3']))
        daf1, dw3, db3 = affine_backward(dss,cache3)
        daf2, dw2, db2 = affine_relu_backward(daf1, cache2)
        dxx,  dw1, db1 = conv_relu_pool_backward(daf2, cache)
